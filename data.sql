...
INSERT INTO visits (id_animals, id_vets, date_of_visit, user_name, timestamp) 
SELECT * FROM (SELECT id_animals FROM animals) id_animals, 
(SELECT id_vets FROM vets) id_vets, 
generate_series('1980-01-01'::timestamp, '2021-01-01', '4 hours') 
visit_timestamp,CURRENT_USER, now();

COMMIT;

insert into owners (full_name, email, user_name, timestamp) 
