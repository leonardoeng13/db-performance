...
SELECT COUNT(id_animals) FROM visits where id_animals = 4;
explain analyze	SELECT COUNT(*) FROM visits where id_animals = 4;
explain analyze	SELECT COUNT(id_animals) FROM visits where id_animals = 4;


explain analyze SELECT * FROM visits where id_vets in(2);
explain analyze SELECT * FROM visits where id_vets = 2;

explain analyze	SELECT * FROM owners where email = 'owner_18327@mail.com';
explain analyze	SELECT * FROM owners where email in('owner_18327@mail.com');
